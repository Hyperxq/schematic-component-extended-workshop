...
type ComponentOptions = AngularComponentOptionsSchema & ComponentExtendedSchema;
...
interface ComponentExtendedSchema {
  /**
...
declare function componentFactory(options: ComponentOptions): Rule;
