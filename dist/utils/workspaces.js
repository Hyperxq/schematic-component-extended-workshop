...
var utils_workspaceModels = require('./workspace-models.js');
 ...
 */ function updateWorkspace(updater) {
    return async (host)=>{
        ...
        await core.workspaces.writeWorkspace(workspace, new TreeWorkspaceHost(host));
 ...
 */ function buildDefaultPath(project) {
    ...
    const projectDirName = project.extensions['projectType'] === utils_workspaceModels.ProjectType.Application ? 'app' : 'lib';
